    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taxno') ? 'is-invalid' : '' }}" type="text" name="taxno"
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('factor') ? 'is-invalid' : '' }}" name="factor_id"
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('license') ? 'is-invalid' : '' }}" type="text" name="license"
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('planes') ? 'is-invalid' : '' }}" name="planes[]"
                        id="planes" multiple>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('medical_due') ? 'is-invalid' : '' }}" type="text"
                       name="medical_due" id="medical_due" value="{{ old('medical_due', $user->medical_due) }}">
