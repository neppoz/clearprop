    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taxno') ? 'is-invalid' : '' }}" type="text" name="taxno" id="taxno" value="{{ old('taxno', $user->taxno) }}">
                @if($errors->has('taxno'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_1') ? 'is-invalid' : '' }}" type="text" name="phone_1" id="phone_1" value="{{ old('phone_1', $user->phone_1) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('factor') ? 'is-invalid' : '' }}" name="factor_id" id="factor_id" required>
                    @foreach($factors as $id => $factor)
                        <option value="{{ $id }}" {{ ($user->factor ? $user->factor->id : old('factor_id')) == $id ? 'selected' : '' }}>{{ $factor }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('license') ? 'is-invalid' : '' }}" type="text" name="license" id="license" value="{{ old('license', $user->license) }}">
