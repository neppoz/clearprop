        ...
        <form method="POST" action="{{ route("admin.activities.update", [$activity->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('plane') ? 'is-invalid' : '' }}" name="plane_id"
                    ...
                    @foreach($planes as $id => $plane)
                        <option
                            value="{{ $id }}" {{ ($activity->plane ? $activity->plane->id : old('plane_id')) == $id ? 'selected' : '' }}>{{ $plane }}</option>
                    @endforeach
                </select>
                @if($errors->has('plane'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('event') ? 'is-invalid' : '' }}" type="text"
                       name="event" id="event" value="{{ old('event', $activity->event) }}" required>
                @if($errors->has('event'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('engine_warmup') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="engine_warmup" id="engine_warmup"
                           value="1" {{ $activity->engine_warmup || old('engine_warmup', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('warmup_start') ? 'is-invalid' : '' }}" type="number"
                       name="warmup_start" id="warmup_start" value="{{ old('warmup_start', $activity->warmup_start) }}"
                       step="0.01" readonly>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_start') ? 'is-invalid' : '' }}" type="number"
                       name="counter_start" id="counter_start"
                       value="{{ old('counter_start', $activity->counter_start) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_stop') ? 'is-invalid' : '' }}" type="number"
                       name="counter_stop" id="counter_stop" value="{{ old('counter_stop', $activity->counter_stop) }}"
                       step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('departure') ? 'is-invalid' : '' }}" type="text"
                       name="departure" id="departure" value="{{ old('departure', $activity->departure) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('arrival') ? 'is-invalid' : '' }}" type="text" name="arrival"
                       id="arrival" value="{{ old('arrival', $activity->arrival) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('event_start') ? 'is-invalid' : '' }}" type="text"
                       name="event_start" id="event_start" value="{{ old('event_start', $activity->event_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('event_stop') ? 'is-invalid' : '' }}" type="text"
                       name="event_stop" id="event_stop" value="{{ old('event_stop', $activity->event_stop) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                          id="description">{{ old('description', $activity->description) }}</textarea>
