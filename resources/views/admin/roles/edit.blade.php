        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.roles.update", [$role->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @endif
                    <span class="help-block text-secondary small">{{ trans('cruds.role.fields.title_helper') }}</span>
                </div>
                <div class="form-group">
                    ...
                    @endif
                    <span class="help-block text-secondary small">{{ trans('cruds.role.fields.permissions_helper') }}</span>
                </div>
                <div class="form-group">
