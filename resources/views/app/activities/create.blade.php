...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("app.activities.store") }}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block text-secondary small">{{ trans('cruds.activity.fields.type_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required">{{ trans('cruds.activity.fields.split_cost') }}</label>
                @foreach(App\Activity::SPLIT_COST_RADIO as $key => $label)
                    <div
                        class="form-check form-check-inline icheck-primary {{ $errors->has('split_cost') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="split_cost_{{ $key }}" name="split_cost"
                               value="{{ $key }}"
                               {{ old('split_cost', '0') === (string) $key ? 'checked' : '' }} required>
                ...
                @endif
                <span
                    class="help-block text-secondary small">{{ trans('cruds.activity.fields.split_cost_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="copilot_id">{{ trans('cruds.activity.fields.copilot') }}</label>
                <select class="form-control select2 {{ $errors->has('copilot') ? 'is-invalid' : '' }}" name="copilot_id"
                        id="copilot_id" disabled>
                    @foreach($copilots as $id => $copilot)
                        <option
                            value="{{ $id }}" {{ old('copilot_id') == $id ? 'selected' : '' }}>{{ $copilot }}</option>
                    @endforeach
                </select>
                @if($errors->has('copilot'))
                    <span class="text-danger">{{ $errors->first('copilot') }}</span>
                @endif
                <span class="help-block text-secondary small">{{ trans('cruds.activity.fields.copilot_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                @endif
                <span
                    class="help-block text-secondary small">{{ trans('cruds.activity.fields.instructor_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                @endif
                <span class="help-block text-secondary small">{{ trans('cruds.activity.fields.plane_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    @endif
                    <span
                        class="help-block text-secondary small">{{ trans('cruds.activity.fields.event_helper') }}</span>
                </div>
            </div>
            <div class="form-group">
                <div
                    class="form-check form-check-inline icheck-primary {{ $errors->has('engine_warmup') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="engine_warmup" id="engine_warmup"
                           value="1" {{ old('engine_warmup', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label"
                           for="engine_warmup">{{ trans('cruds.activity.fields.engine_warmup') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('warmup_start') ? 'is-invalid' : '' }}" type="number"
                       name="warmup_start" id="warmup_start" value="{{ old('warmup_start', '0') }}" step="0.01"
                       readonly>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_start') ? 'is-invalid' : '' }}" type="number"
                       name="counter_start" id="counter_start" value="{{ old('counter_start', '0') }}" step="0.01"
                       required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_stop') ? 'is-invalid' : '' }}" type="number"
                       name="counter_stop" id="counter_stop" value="{{ old('counter_stop', '0') }}" step="0.01"
                       required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('departure') ? 'is-invalid' : '' }}" type="text"
                       name="departure" id="departure" value="{{ old('departure', '') }}">
                @if($errors->has('departure'))
                    <span class="text-danger">{{ $errors->first('departure') }}</span>
                @endif
                <span
                    class="help-block text-secondary small">{{ trans('cruds.activity.fields.departure_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="arrival">{{ trans('cruds.activity.fields.arrival') }}</label>
                <input class="form-control {{ $errors->has('arrival') ? 'is-invalid' : '' }}" type="text" name="arrival"
                       id="arrival" value="{{ old('arrival', '') }}">
                @if($errors->has('arrival'))
                    <span class="text-danger">{{ $errors->first('arrival') }}</span>
                @endif
                <span class="help-block text-secondary small">{{ trans('cruds.activity.fields.arrival_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control timepicker {{ $errors->has('event_start') ? 'is-invalid' : '' }}"
                           type="text" name="event_start" id="event_start" value="{{ old('event_start') }}">
                    @if($errors->has('event_start'))
                        <span class="text-danger">{{ $errors->first('event_start') }}</span>
                    @endif
                    <span
                        class="help-block text-secondary small">{{ trans('cruds.activity.fields.event_start_helper') }}</span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control timepicker {{ $errors->has('event_stop') ? 'is-invalid' : '' }}"
                           type="text" name="event_stop" id="event_stop" value="{{ old('event_stop') }}">
                    @if($errors->has('event_stop'))
                        <span class="text-danger">{{ $errors->first('event_stop') }}</span>
                    @endif
                    <span
                        class="help-block text-secondary small">{{ trans('cruds.activity.fields.event_stop_helper') }}</span>
                </div>
            </div>
            <div class="form-group">
                ...
                @endif
                <span
                    class="help-block text-secondary small">{{ trans('cruds.activity.fields.description_helper') }}</span>
            </div>
            <div class="form-group">
