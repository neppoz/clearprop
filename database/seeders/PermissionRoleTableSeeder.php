...
class PermissionRoleTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $manager_permissions = [1, 35, 37, 39, 40, 41, 42, 43, 83, 84, 85, 86, 87, 88, 89, 108, 112, 113, 115, 116, 117, 118, 119, 120];
        ...
        $instructor_permissions = [35, 37, 39, 40, 41, 42, 43, 83, 84, 85, 86, 87, 88, 89, 108, 112, 113, 117, 118, 119];
        Role::findOrFail(\App\User::IS_INSTRUCTOR)->permissions()->syncWithoutDetaching($instructor_permissions);

        $mechanic_permissions = [35, 37, 39, 40, 41, 42, 43, 83, 84, 85, 86, 87, 88, 89, 108, 117, 119];
