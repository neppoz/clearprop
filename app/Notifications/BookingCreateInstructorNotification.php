...
class BookingCreateInstructorNotification extends Notification
{
    use Queueable;
    ...
    public function getMessage()
    {
        return (new MailMessage)
            ->subject(config('app.name') . ': Instructor invitation')
            ->greeting('Hi,')
            ->line('we would like to confirm that a ' .strtolower(trans('cruds.booking.title_singular')). ' has been created.')
            ->line('')
            ...
            ->line(new HtmlString('<strong>This is a lesson request. Please log in and confirm the invitation.</strong>'))
