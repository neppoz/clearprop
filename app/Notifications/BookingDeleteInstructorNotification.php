...
class BookingDeleteInstructorNotification extends Notification
{
    use Queueable;
    ...
    public function getMessage()
    {
        return (new MailMessage)
            ->subject(config('app.name') . ': Instructor reservation cancelled')
            ->greeting('Hi,')
            ...
            //->action(trans('global.edit'). ' '. strtolower(trans('cruds.booking.title_singular')), config('app.url') . '/admin/bookings/'. $this->event->booking->id .'/edit')
            ->line('Happy landings,')
